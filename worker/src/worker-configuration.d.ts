/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false src/worker-configuration.d.ts` (hash: 2fc024b3fc8ff96a87434d3a98d3ce5f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_API_KEY">> {}
}
